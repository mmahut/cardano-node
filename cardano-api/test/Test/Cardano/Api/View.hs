...
prop_roundtrip_CredentialShelley_view :: Property
prop_roundtrip_CredentialShelley_view =
  H.property $ do
    addr <- H.forAll genCredentialShelley
    H.tripping addr renderCredentialView parseCredentialView
